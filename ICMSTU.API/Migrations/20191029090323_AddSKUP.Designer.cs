...
namespace ICMSTU.API.Migrations
{
    ...
    [Migration("20191029090323_AddSKUP")]
    partial class AddSKUP
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.Bendahara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("SaldoBend")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("SaldoBendt")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<DateTime>("TglNonAktif");
                    ...
                    b.HasIndex("JnsBendId");

                    b.HasIndex("PegawaiId");

                    b.HasIndex("UnitOrganisasiId");

                    b.HasIndex("NoSK", "UnitOrganisasiId", "BankId", "JnsBendId", "PegawaiId");
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.JnsBend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.RKUD", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("BankId", "NamaRekening", "NoRekening")
                        .IsUnique()
                        .HasFilter("[NamaRekening] IS NOT NULL AND [NoRekening] IS NOT NULL");
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.SKUP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime?>("TglSK");

                    b.HasKey("Id");

                    b.HasIndex("NoSK")
                        .IsUnique()
                        .HasFilter("[NoSK] IS NOT NULL");

                    b.ToTable("SKUP");
                });

            modelBuilder.Entity("ICMSTU.API.Models.Entities.SKUPDet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("SKUPId", "UnitOrganisasiId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.Bendahara", b =>
                {
                    b.HasOne("ICMSTU.API.Models.Entities.Bank", "Bank")
                        .WithMany()
                        .HasForeignKey("BankId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ICMSTU.API.Models.Entities.JnsBend", "JnsBend")
                        .WithMany()
                        .HasForeignKey("JnsBendId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ICMSTU.API.Models.Entities.SKUPDet", b =>
                {
                    b.HasOne("ICMSTU.API.Models.Entities.SKUP", "SKUP")
                        .WithMany("SKUPDet")
                        .HasForeignKey("SKUPId")
                        .OnDelete(DeleteBehavior.Cascade);
